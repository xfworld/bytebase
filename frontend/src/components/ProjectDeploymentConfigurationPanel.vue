...
export default defineComponent({
  ...
  setup(props) {
    ...
    const availableLabelList = computed((): AvailableLabel[] => {
      ...
      // "bb.environment" is not a real user-define-able label like bb.location
      //   or bb.tenant
      // it's auto generated by backend from the environment it belongs to
      // so we need to inject a group of AvailableLabel by the environmentList
